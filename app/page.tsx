...
import { Trophy, Users, Calendar, ArrowRight, Dices, Award, Sparkles, Shield, ShieldCheck } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0a0c0f] text-zinc-100 flex flex-col justify-between overflow-x-hidden relative">
      ...
      <nav className="max-w-7xl w-full mx-auto p-5 sm:p-6 flex justify-between items-center z-10">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-bold tracking-widest uppercase text-sm">Dream XI</span>
        </div>
      ...
      <main className="max-w-4xl w-full mx-auto px-4 py-8 sm:py-16 text-center z-10 flex-1 flex flex-col justify-center">
        ...
        <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-zinc-950 border border-zinc-900 rounded-full text-[10px] font-mono uppercase tracking-widest text-[#e8ff3b] mb-6">
          ...
          <span>Fascinating World Cup Records</span>
        </div>

        {/* Headline with dynamic cycling names */}
        <h1 className="font-display font-black text-4xl sm:text-6xl lg:text-7xl tracking-tighter leading-[0.95] text-white uppercase mb-6 uppercase">
        ...
        <p className="text-sm sm:text-base text-zinc-400 max-w-lg mx-auto leading-relaxed mb-10">
          Randomly roll historical squads, choose tactical formations, recruit iconic global performers, and direct a fully simulated 4-stage FIFA World Cup knockout ladder.
        </p>
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="font-mono text-[9px] text-zinc-500 uppercase tracking-widest">
            no registration required • 100% offline persistence
          </span>
        </div>
        ...
        <section className="grid grid-cols-3 gap-2 border border-zinc-900 rounded-2xl bg-zinc-950/60 p-4 max-w-lg mx-auto mt-16 text-center shadow-lg divide-x divide-zinc-900">
          <div>
            ...
            <p className="font-mono text-[9px] text-zinc-500 uppercase mt-0.5 tracking-wider">Editions</p>
          </div>
          <div>
            <div className="font-display font-bold text-lg sm:text-xl text-zinc-100 flex items-center justify-center gap-1">
            ...
            <p className="font-mono text-[9px] text-zinc-500 uppercase mt-0.5 tracking-wider">Nations</p>
          </div>
          <div>
            <div className="font-display font-bold text-lg sm:text-xl text-zinc-100 flex items-center justify-center gap-1">
            ...
            <p className="font-mono text-[9px] text-zinc-500 uppercase mt-0.5 tracking-wider">Legends</p>
          </div>
        </section>
      ...
      <section className="max-w-5xl w-full mx-auto px-4 py-12 border-t border-zinc-900/60">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-left">
          <div className="p-5 bg-zinc-950/40 border border-zinc-900 rounded-2xl flex flex-col justify-between min-h-[140px]">
            ...
            <div>
              <h4 className="font-display font-bold text-sm text-zinc-100 mb-1">Random Draft Roll</h4>
              <p className="text-xs text-zinc-400 leading-normal">
                Draw a randomized FIFA national team combined with a legendary qualification year (1954 - 2022).
              </p>
            </div>
          </div>
          ...
          <div className="p-5 bg-zinc-950/40 border border-zinc-900 rounded-2xl flex flex-col justify-between min-h-[140px]">
            ...
            <div>
              <h4 className="font-display font-bold text-sm text-zinc-100 mb-1">Deploy Tactics</h4>
              <p className="text-xs text-zinc-400 leading-normal">
                Choose among classic layouts (4-3-3, 3-5-2, 4-2-3-1) mapping key slot coordinate positions.
              </p>
            </div>
          </div>
          ...
          <div className="p-5 bg-zinc-950/40 border border-zinc-900 rounded-2xl flex flex-col justify-between min-h-[140px]">
            ...
            <div>
              <h4 className="font-display font-bold text-sm text-zinc-100 mb-1">Recruit Roster</h4>
              <p className="text-xs text-zinc-400 leading-normal">
                Assemble exact slots with position-compliant candidates. Prevent duplicates to draft the clean OVR averages.
              </p>
            </div>
          </div>
          ...
          <div className="p-5 bg-zinc-950/40 border border-zinc-900 rounded-2xl flex flex-col justify-between min-h-[140px]">
            ...
            <div>
              <h4 className="font-display font-bold text-sm text-zinc-100 mb-1">Knockout Sim</h4>
              <p className="text-xs text-zinc-400 leading-normal">
                Launch the simulation engine. Run progressive knockout rounds (R16, QF, SF, Final) assessing detailed stat files.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="border-t border-zinc-950 bg-black/30 p-6 text-center z-10">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 text-[10px] font-mono text-zinc-650 tracking-wider uppercase">
          <span>© 2026 Dream XI. Decided under vintage sports statistics.</span>
          <span>In iframe bounds • zero cookie trackers</span>
        </div>
      </footer>

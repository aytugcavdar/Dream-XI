...
exports.restRealPlayers = exports.restLegends = void 0;
exports.restLegends = [
    // === CROATIA ===
    {
        id: 'modric',
...
exports.restRealPlayers = {
    turkey: [
        ...
        // 2008 Additions
        { name: 'Semih Şentürk', position: 'ST', gp: 'ATT', rating: 83, years: [2008], bio: 'Known as the "Super Sub," scored legendary late goals in Euro 2008 including the equalizer against Croatia.' },
        { name: 'Tuncay Şanlı', position: 'LW', gp: 'ATT', rating: 85, years: [2002, 2008], bio: 'High-energy, passionate forward who could play in goal when needed, a legend of Euro 2008.' },
        { name: 'Servet Çetin', position: 'CB', gp: 'DEF', rating: 83, years: [2008], bio: 'Imposing central defender known for playing through extreme physical pain in Euro 2008.' },
        { name: 'Sabri Sarıoğlu', position: 'RB', gp: 'DEF', rating: 82, years: [2008], bio: 'Energetic right-back who provided the critical assist to Semih Şentürk against Croatia in 2008.' },
        { name: 'Gökdeniz Karadeniz', position: 'RW', gp: 'ATT', rating: 83, years: [2002, 2008], bio: 'Pacy and clinical winger who provided key depth during Turkey\'s historic 2002 and 2008 runs.' }
    ],
    belgium: [
    ...
    senegal: [
        ...
        { name: 'Habib Beye', position: 'RB', gp: 'DEF', rating: 81, years: [2002, 2008], bio: 'Versatile defender who provided excellent squad depth during the 2002 campaign.' }
    ],
    cameroon: [
